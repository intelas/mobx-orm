...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    __decorate([
        mobx.action('MO: Filter - set'),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object]),
        __metadata("design:returntype", void 0)
    ], SingleFilter.prototype, "set", null);
    __decorate([
        mobx.action('MO: Filter - set from URI'),
        __metadata("design:type", Function),
    ...
    class Query extends QueryBase {
        ...
        __watch_obj(obj) {
            ...
            this.__disposer_objects[obj.id] = mobx.reaction(() => !this.filters || this.filters.isMatch(obj), mobx.action('MO: Query - obj was changed', (should) => {
                let i = this.__items.indexOf(obj);
    ...
    __decorate([
        mobx.action('MO: obj - update from raw'),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object]),
        __metadata("design:returntype", void 0)
    ], Model.prototype, "updateFromRaw", null);
    __decorate([
        mobx.action('MO: model - inject'),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Model]),
        __metadata("design:returntype", void 0)
    ], Model, "inject", null);
    __decorate([
        mobx.action('MO: model - eject'),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Model]),
        __metadata("design:returntype", void 0)
    ], Model, "eject", null);
    __decorate([
        mobx.action('MO: model - update the cache from raw'),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object]),
        __metadata("design:returntype", Model)
    ], Model, "updateCache", null);
    __decorate([
        mobx.action('MO: model - clear the cache'),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", void 0)
